...
-- タブ作成（3タブ構成）
-- ==========================================
local AttackTab = Window:MakeTab({Name = "攻撃", Icon = "rbxassetid://4483362458", PremiumOnly = false})
local DefenseTab = Window:MakeTab({Name = "防御", Icon = "rbxassetid://4483362458", PremiumOnly = false})
local OtherTab = Window:MakeTab({Name = "その他", Icon = "rbxassetid://4483362458", PremiumOnly = false})
...
OtherTab:AddSection({Name = "ラインラグサーバー"})
OtherTab:AddButton({Name = "Start Lag (ラグ開始)", Callback = function() startLineLag() end})
OtherTab:AddButton({Name = "Stop Lag (ラグ停止)", Callback = function() stopLineLag() end})
...
OtherTab:AddSection({Name = "Walkspeed"})
OtherTab:AddToggle({Name = "Walkspeed", Default = false, Callback = function(Value) PlayerSettings.Walkspeed = Value WalkspeedFunc() end})
OtherTab:AddSlider({Name = "Speed 倍率", Min = 0.1, Max = 5, Default = 1, Increment = 0.1, ValueName = "x", Callback = function(Value) PlayerSettings.WalkspeedValue = Value end})

OtherTab:AddSection({Name = "Infinite Jump"})
OtherTab:AddToggle({Name = "Infinite Jump", Default = false, Callback = function(Value) PlayerSettings.InfiniteJump = Value InfiniteJumpFunc() end})
OtherTab:AddSlider({Name = "Jump Power", Min = 16, Max = 500, Default = 100, Increment = 1, ValueName = "パワー", Callback = function(Value) PlayerSettings.InfiniteJumpPower = Value end})

OtherTab:AddSection({Name = "Camera"})
OtherTab:AddSlider({Name = "FOV", Min = 70, Max = 120, Default = 70, Increment = 1, ValueName = "°", Callback = function(Value) Workspace.CurrentCamera.FieldOfView = Value end})
...
OtherTab:AddParagraph("使い方", "・家の外で実行してください\n・1回だけ実行されます")
...
-- Anti Grab
DefenseTab:AddSection({Name = "アンチ Grab"})
...
-- Anti Kick
DefenseTab:AddSection({Name = "アンチ Kick"})
...
-- Anti Ragdoll
DefenseTab:AddSection({Name = "アンチ Ragdoll"})
...
-- Anti Blobman Kill
DefenseTab:AddSection({Name = "アンチ Blobman Kill"})
...
-- Anti Lag
DefenseTab:AddSection({Name = "アンチ Lag"})
...
-- Anti Explosion
DefenseTab:AddSection({Name = "アンチ Explosion"})
...
-- Anti Fire
DefenseTab:AddSection({Name = "アンチ Fire"})
...
AttackTab:AddSection({Name = "プレイヤー選択"})
local kickPlayerDropdown = AttackTab:AddDropdown({
    Name = "プレイヤー選択",
    Default = "",
...
AttackTab:AddButton({Name = "プレイヤーリスト更新", Callback = function() kickPlayerDropdown:Refresh(getPlayerList(), true) end})

-- ==========================================
-- 攻撃タブ - 高速キック
-- ==========================================
AttackTab:AddSection({Name = "高速キック"})
...
-- 攻撃タブ - 上下キック
-- ==========================================
AttackTab:AddSection({Name = "上下キック"})
...
-- 攻撃タブ - スピンキック
-- ==========================================
AttackTab:AddSection({Name = "スピンキック"})
local spinAngle = 0
local spinSpeed = 15

AttackTab:AddSlider({Name = "回転速度", Min = 1, Max = 50, Default = 15, Increment = 1, ValueName = "速度", Callback = function(Value) spinSpeed = Value end})
...
-- 攻撃タブ - ドリフトキック
-- ==========================================
AttackTab:AddSection({Name = "ドリフトキック"})
local orbitRadius = 15
local orbitSpeed2 = 2
local orbitAngle = 0

AttackTab:AddSlider({Name = "周回半径", Min = 5, Max = 30, Default = 15, Increment = 1, ValueName = "m", Callback = function(Value) orbitRadius = Value end})
AttackTab:AddSlider({Name = "周回速度", Min = 1, Max = 10, Default = 2, Increment = 1, ValueName = "速度", Callback = function(Value) orbitSpeed2 = Value end})
...
-- 攻撃タブ - ブロブキック（右手→左手→上）
-- ==========================================
AttackTab:AddSection({Name = "ブロブキック (右手→左手→上)"})
...
local function getKickPlayerFromSelection2(selection)
    return getPlayerFromSelection(selection)
end
...
local function getHandPosition(blob, hand)
    ...
    if hand == "right" then
        ...
        if rHand then pos = rHand.Position end
    elseif hand == "left" then
        local lHand = blob:FindFirstChild("LeftHand")
        if lHand then pos = lHand.Position end
    end
    return pos
end

local kickPlayerDropdown2 = AttackTab:AddDropdown({
    Name = "プレイヤー選択",
    Default = "",
...
AttackTab:AddButton({
    Name = "プレイヤーリスト更新",
    Callback = function()
        kickPlayerDropdown2:Refresh(getKickPlayerList2(), true)
    end
})
            ...
            while kickLoopEnabled2 do
                ...
                if tRoot and tHum and tHum.Health > 0 then
                    ...
                    if currentPattern == "right" then
                        ...
                        if handPos then targetPos = CFrame.new(handPos + Vector3.new(0, 2, 0)) end
                    elseif currentPattern == "left" then
                        local handPos = getHandPosition(blob, "left")
                        if handPos then targetPos = CFrame.new(handPos + Vector3.new(0, 2, 0)) end
                    elseif currentPattern == "up" then
                        targetPos = CFrame.new(SavedPos.X + math.random(-2, 2), 50 + math.random(0, 20), SavedPos.Z + math.random(-2, 2))
                    end
                    if targetPos then
                        tRoot.CFrame = targetPos
                        tRoot.Velocity = Vector3.zero
...
-- 攻撃タブ - ブロブキックv1
-- ==========================================
AttackTab:AddSection({Name = "ブロブキックv1"})
local kick2V1Enabled = false
local kick2V1Thread = nil
local whitelistFriends = false

AttackTab:AddToggle({Name = "ホワイトリスト（フレンド除外）", Default = false, Callback = function(Value) whitelistFriends = Value end})
...
AttackTab:AddToggle({
    ...
    Callback = function(on)
        ...
        kick2V1Enabled = on
        if on and not selectedKickPlayer then OrionLib:MakeNotification({Name = "エラー", Content = "ターゲットを選択してください", Time = 3}) kick2V1Enabled = false return end
        if on and selectedKickPlayer and whitelistFriends then
            local isFriend = false
            pcall(function() isFriend = LocalPlayer:IsFriendsWith(selectedKickPlayer.UserId) end)
...
-- 攻撃タブ - ブロブキックv2
-- ==========================================
AttackTab:AddSection({Name = "ブロブキックv2"})
...
AttackTab:AddToggle({
    ...
    Callback = function(on)
        ...
        kick2V2Enabled = on
        if on and not selectedKickPlayer then OrionLib:MakeNotification({Name = "エラー", Content = "ターゲットを選択してください", Time = 3}) kick2V2Enabled = false return end
        if on and selectedKickPlayer and whitelistFriends then
            local isFriend = false
            pcall(function() isFriend = LocalPlayer:IsFriendsWith(selectedKickPlayer.UserId) end)
...
-- 攻撃タブ - ラグドール
-- ==========================================
AttackTab:AddSection({Name = "ラグドール"})
...
local function SetNetworkOwnerForTarget(targetRoot)
    ...
    pcall(function() setNetworkOwnerEvent:FireServer(targetRoot, targetRoot.CFrame) end)
end

local function DoDestroyGrabLine(targetRoot)
    if not targetRoot then return end
    pcall(function() destroyGrabLineEvent:FireServer(targetRoot) end)
end

local function CreateBodiesRagdoll(targetRoot, pos)
    if currentBodyPosition then currentBodyPosition:Destroy() currentBodyPosition = nil end
...
local function StopAllRagdoll()
    isSpamActive = false
    if currentSpamTask then task.cancel(currentSpamTask) currentSpamTask = nil end
    if currentMainTask then task.cancel(currentMainTask) currentMainTask = nil end
...
local ragdollPlayerDropdown = AttackTab:AddDropdown({
    Name = "ラグドール対象",
    Default = "",
    Options = getPlayerList(),
    Callback = function(selected)
        if selected then currentRagdollTarget = getPlayerFromSelection(selected) end
    end
})

AttackTab:AddButton({
    Name = "プレイヤーリスト更新",
    Callback = function() ragdollPlayerDropdown:Refresh(getPlayerList(), true) end
})
    ...
    Callback = function(Value)
        if Value then
            ...
            currentMainTask = task.spawn(function()
                ...
                if not target then StopAllRagdoll() return end
                local myChar = LocalPlayer.Character
                local myRoot = myChar and myChar:FindFirstChild("HumanoidRootPart")
                if not myRoot then StopAllRagdoll() return end
                    ...
                    if tRoot and tHum and tHum.Health > 0 and myRoot then
                        ...
                        if not dragging then
                            ...
                            if currentBodyPosition and currentBodyPosition.Parent then
                                ...
                                if currentBodyGyro then currentBodyGyro.CFrame = lockPos end
                            else
                                CreateBodiesRagdoll(tRoot, lockPos.Position)
                            end
            ...
            if isSpamActive then StopAllRagdoll() end
        end
    end
})
...
-- 攻撃タブ - 永続キル
-- ==========================================
AttackTab:AddSection({Name = "選択プレイヤーキル"})
...
local function SpawnBlobmanForKill()
    ...
    if currentBlobman and currentBlobman.Parent then
        ...
        if blobmanPos and localPos and (blobmanPos - localPos).Magnitude < 500 then
...
local function StartSelectedKillLoop()
    while isSelectedKill do
        if selectedKillPlayer then
            pcall(ProcessPlayer, selectedKillPlayer)
        end
        task.wait(0.05)
    end
...
local killPlayerDropdown = AttackTab:AddDropdown({
    Name = "キル対象",
    Default = "",
    Options = getPlayerList(),
    Callback = function(Value)
        selectedKillPlayer = getPlayerFromSelection(Value)
    end
})

AttackTab:AddButton({Name = "プレイヤーリスト更新", Callback = function() killPlayerDropdown:Refresh(getPlayerList(), true) end})
...
-- 攻撃タブ - キルオーラ
-- ==========================================
AttackTab:AddSection({Name = "キルオーラ"})
...
AttackTab:AddSlider({Name = "オーラ範囲", Min = 10, Max = 100, Default = 35, Increment = 1, ValueName = "スタッド", Callback = function(Value) AURA_RADIUS = Value end})

-- ==========================================
-- 攻撃タブ - 緊急停止
-- ==========================================
AttackTab:AddSection({Name = "緊急停止"})
AttackTab:AddButton({
    Name = "全機能緊急停止",
    Callback = function()
        kick67Enabled = false
